<template>
  <div id="home" class="max-w-7xl  mx-auto relative overflow-hidden  pt-[120px] md:pt-[130px] lg:pt-[160px]">
    <div class="container px-4 mx-auto">
      <div class="flex flex-wrap items-center -mx-4">
        <div class="mx-auto px-4 py-4 flex justify-between items-center bg-transparent">
          <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-start w-1/2"
              data-wow-delay=".2s"
          >
            <h1
                class="mb-6 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]"
            >
              LAUNCH YOUR OTA IN 48 HOURS
            </h1>
            <p
                class="mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]"
            >
              A complete solution empowering travel agencies to
              streamline operations, enhance efficiency, and achieve
              sustainable growth in a competitive market.
            </p>
            <ul
                class="flex flex-wrap  gap-5 mb-10"
            >
              <li>
                <a
                    href="https://links.tailgrids.com/play-download"
                    class="inline-flex items-center justify-center rounded-md bg-white px-7 py-[14px] text-center text-base font-medium text-black border border-black
                     shadow-1 transition duration-300 ease-in-out hover:bg-transparent  hover:text-white hover:border-white"
                >
                  Download Now
                </a>
              </li>
            ...
            <div>
              <p class="mb-4 text-base font-medium text-center text-dark">
          ...
          <div class="wow fadeInUp relative z-10 mx-auto max-w-[845px] w-1/2"
              data-wow-delay=".25s"
          >
            <div class="mt-16">
              <img
                  src="/market-assets/images/background/hero222 (1).png"
                  alt="hero"
        ...
        <div class="w-full px-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div
                ...
                :key="category.id"
                class="relative h-80 rounded-3xl overflow-hidden group shadow-lg hover:shadow-2xl transition"
            >
              <nuxt-link :to="`/market/products/${category.slug}`">

              <div class="relative h-80 rounded-3xl overflow-hidden group shadow-lg hover:shadow-2xl transition">
                <!-- تصویر -->
                <img
                    :src="`${config.public.fileBase}/${category.image}`"
                ...
                <!-- متن -->
                <div class="absolute bottom-0 p-5 text-white z-20">
                  <h2 class="mt-1 text-2xl font-semibold line-clamp-2 text-center">
                    {{ category?.title?.en }}
                  </h2>

                  <span class="flex items-center text-xs uppercase tracking-widest text-white/70 gap-2">
                    Products
                    <svg width="16" height="16" viewBox="0 0 185.343 185.343" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const page=ref(1)
const {data:categories, error, pending, refresh, clear} = useFetch(() => `/categories?page=${page.value}`, {
