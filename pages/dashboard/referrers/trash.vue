                  ...
                  <td>
                    <div class="btn-group my-1">
                      ...
                      <ul class="dropdown-menu">
                        <li v-if="auth.user.permissions.includes('referrer.restore')"><a
                            class="dropdown-item modal-effect" @click="restoreReferrer(referrer.id)"
                            href="javascript:void(0);">Restore</a></li>
                        <li v-if="auth.user.permissions.includes('referrer.delete')"><a data-bs-effect="effect-flip-vertical"  data-bs-toggle="modal" data-bs-target="#delete" class="dropdown-item modal-effect" @click="setReferrer(referrer.id)" href="javascript:void(0);">Delete</a></li>
                      </ul>
                    </div>
                  </td>
                </tr>
...
const hasPermission = computed(() => {
  return auth.user?.permissions?.includes('referrer.trash') || false
})
