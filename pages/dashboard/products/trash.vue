      ...
      <div class="col-xl-12">
        <div class="card custom-card">
          ...
          <div class="card-body">
            ...
            <div v-else-if="!trashedProducts?.data || trashedProducts?.data?.length === 0">
            ...
            <div v-else class="table-responsive">
              <table class="table text-nowrap">
                ...
                <tbody>
                <tr v-for="(product, index) in trashedProducts?.data" :key="product.id">
                  <td>{{ index + 1 }}</td>
                  ...
                  <td>
                    <div class="btn-group my-1">
                      ...
                      <ul class="dropdown-menu">
                        <li v-if="auth.user.permissions.includes('product.restore')"><a @click="restoreProduct(product.id)" class="dropdown-item cursor-pointer">Restore</a></li>
                        <li>
                          <hr class="dropdown-divider">
                        </li>
                        <li v-if="auth.user.permissions.includes('product.delete')"><a data-bs-toggle="modal" data-bs-effect="effect-flip-vertical" data-bs-target="#force-delete"  @click="setProduct(product.id)" class="dropdown-item modal-effect"  href="#force-delete">Delete</a></li>
                      </ul>
                    </div>
                  </td>
                </tr>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="forceDeleteModalLabel">Delete Product</h5>
...
const { data: trashedProducts, pending: isLoadingProducts, error, refresh: fetchTrashedProducts } = await useAsyncData(
    'product-trash',
    () =>
        $fetch('/products/trash', {
...
async function confirmForceDeleteProduct() {
  ...
  try {
    ...
    nuxtApp.$toast({
      title: 'Error!',
      message: 'Product deleted unseccessfully.',
      type: 'error',
      duration: 3000
    })
  } finally {
