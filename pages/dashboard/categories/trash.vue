...
<template>
  <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <h1 class="page-title fw-semibold fs-18 mb-0">Trash Categories</h1>
      ...
      <div class="card custom-card">
        <div class="card-header justify-content-between">
          ...
          <div class="prism-toggle">
            <nuxt-link to="/dashboard/categories" class="btn btn-sm btn-warning-light mx-1 ">Back<i
                class="ri-arrow-go-back-line ms-2 d-inline-block align-middle"></i></nuxt-link >
          </div>
        </div>
        <div class="card-body">
