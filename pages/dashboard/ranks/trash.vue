                ...
                <td>
                  <div class="btn-group my-1">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a data-bs-effect="effect-flip-vertical"  data-bs-toggle="modal" data-bs-target="#delete" class="dropdown-item modal-effect" @click="setRank(rank.id)" href="javascript:void(0);">Delete</a></li>
                    </ul>
                  </div>
                </td>
              </tr>
